...
def generate_report(google_news, newsapi_news):
        ...
        <style>
            ...
            * { box-sizing: border-box; margin: 0; padding: 0; }
            ...
            .container { 
                ...
                position: relative;
                min-height: 100vh;
                padding-bottom: 100px; /* Space for logo */
            }
            ...
            @media (max-width: 480px) {
                ...
                h1 { font-size: 1.3em; }
                .logo-container { bottom: 10px; right: 10px; }
                .logo { width: 80px; }
            }
        </style>
    </head>
    ...
    html_content += """
            ...
            <div class="construction-banner" style="
                text-align: center;
                padding: 20px;
                margin: 40px 0;
                background: #fff9e6;
            ...
            ">
                ...
                <h3 style="color: #b8860b; margin: 0;">Topic Analysis Section Under Construction</h3>
                <p style="color: #6b4423; margin-top: 5px;">We're working on improving our topic visualization. Please check back soon!</p>
            </div>
